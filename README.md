A simple dental clinic website built using React, designed to provide users with an easy and interactive way to learn about the clinic and book appointments.
